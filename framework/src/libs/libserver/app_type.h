...
enum APP_TYPE
{
    ...
    APP_DB_MGR = 1,             // 1 DbMgr
    APP_GAME_MGR = 1 << 1,      // 2 GameMgr
    APP_SPACE_MGR = 1 << 2,     // 4 SpaceMgr

    APP_LOGIN = 1 << 3,         // 8 登录
    APP_GAME = 1 << 4,          // 16 GameServer
    APP_SPACE = 1 << 5,         // 32 SpaceServer
    APP_ROBOT = 1 << 6,

    APP_APPMGR = APP_GAME_MGR | APP_SPACE_MGR,      // 6 AppMgr （含GameMgr+SpaceMgr）
